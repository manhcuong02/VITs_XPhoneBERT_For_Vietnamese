...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_file", default="infore25h/segment_text/training_phoneme_sequences.txt")
    parser.add_argument("--output_file", default="infore25h/segment_text/validation_phoneme_sequences.txt")
